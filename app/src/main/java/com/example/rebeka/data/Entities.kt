...
data class AppSettings(
    ...
    // Тестовая блокировка «прямо сейчас», вызванная кнопкой из приложения.
    // Снимается ровно теми же двумя способами, что и обычная: PIN или 5000 шагов.
    val forcedBlockActive: Boolean = false,
    // Сколько шагов было в момент включения тестовой блокировки — от этой отметки
    // отсчитываются 5000 шагов на разблокировку.
    val forcedBlockStepsBaseline: Long = 0
)
